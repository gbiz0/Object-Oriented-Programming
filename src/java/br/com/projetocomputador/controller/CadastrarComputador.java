...
public class CadastrarComputador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String precoComputador = request.getParameter("precoComputador");
            String ramComputador = request.getParameter("ramComputador");
            String ssdComputador = request.getParameter ("ssdComputador");
