...
@WebServlet(name = "ListarComputador", urlPatterns = {"/ListarComputador"})
public class ListarComputador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("listarcomputador.jsp").forward(request, response);
                ...
                System.out.println("Erro ao listar o funcionários! ERRO:"+ e.getMessage());
                e.printStackTrace();
            }
        }
    }
